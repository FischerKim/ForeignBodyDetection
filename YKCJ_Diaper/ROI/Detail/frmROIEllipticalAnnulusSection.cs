...
{
    public partial class frmROIEllipticalAnnulusSection : CROIWindow
    {
        #region VARIABLE
        private CRecipeDesignTool m_OTool = null;
        private CBlobRecipe m_ORecipe = null;
        private CogEllipticalAnnulusSection m_OGraphic = null;
        ...
        public override CBlobRecipe ORecipe
        {
            set
            {
                try
                {
                    ...
                    this.m_OGraphic = (CogEllipticalAnnulusSection)value.OROI.OGraphic;
        ...
        public frmROIEllipticalAnnulusSection()
        {
            InitializeComponent();
        }
        #endregion
